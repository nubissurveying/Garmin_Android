...
import com.garmin.android.apps.connectiq.sample.comm.Service.AccelerometerService;
...
public class DeviceActivity extends ListActivity implements View.OnClickListener {
    ...
    public static final String MYCONNECTIQ = "MYCONNECTIQ_SERVICE";
    public static final String MYAPP = "MYAPP_SERVICE";
    public static final String MYDEVICE = "MYDEVICE_SERVICE";
...
//            accelerometerIntent.putExtra(MYCONNECTIQ, (Parcelable) mConnectIQ);
            accelerometerIntent.putExtra(MYDEVICE, mDevice);
            accelerometerIntent.putExtra(MYAPP, mMyApp);
...
//                        }
//
//                        Log.e("DeviceActivity", builder.toString());
